...
urlpatterns = patterns('',
    ...
    url(r'^account/groups/del/(?P<groupname>[-A-Za-z0-9_]+)/(?P<username>[-A-Za-z0-9_]+)$', 'student.management.views.usergroup_member_delete', name='usergroup_member_delete'),
    url(r'^account/groups/del/(?P<groupname>[-A-Za-z0-9_]+)$', 'student.management.views.usergroup_delete', name='usergroup_delete'),
